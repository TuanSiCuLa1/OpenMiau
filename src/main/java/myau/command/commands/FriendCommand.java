            ...
            switch (subCommand) {
                ...
                case "add":
                    ...
                    for (String name: args.subList(2, args.size())) {
                        ...
                        if (added == null) {
                            ChatUtil.display(String.format("%s&o%s&r is already in your friend list&r", Myau.clientName, name));
                        } else {
                            ChatUtil.display(String.format("%sAdded &o%s&r to your friend list&r", Myau.clientName, added));
                        }
                    }
                    return;
                case "r":
                case "remove":
                    ...
                    for (String name: args.subList(2, args.size())){
                        ...
                        if (removed == null) {
                            ChatUtil.display(String.format("%s&o%s&r is not in your friend list&r", Myau.clientName, name));
                        } else {
                            ChatUtil.display(String.format("%sRemoved &o%s&r from your friend list&r", Myau.clientName, removed));
                        }
                    }
                    return;
                case "l":
                case "list":
                    ...
                    if (list.isEmpty()) {
                        ChatUtil.display(String.format("%sNo friends&r", Myau.clientName));
                        return;
                    }
                    ChatUtil.display(String.format("%sFriends:&r", Myau.clientName));
                ...
                case "clear":
                    ...
                    ChatUtil.display(String.format("%sCleared your friend list&r", Myau.clientName));
                    return;
                default:
                    if (args.size() == 2) {
