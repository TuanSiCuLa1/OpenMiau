...
public final class Ambience extends Module {
    ...
    public final ModeProperty weather = new ModeProperty("Weather", 0, new String[]{
            "Unchanged", "Clear", "Rain", "Heavy Snow", "Light Snow", "Nether Particles"
    });

    public final ColorProperty snowColor = new ColorProperty("Snow Color", Color.WHITE.getRGB(),
            () -> !weather.getModeString().equals("Heavy Snow") && !weather.getModeString().equals("Light Snow"));
    ...
    public void onPacket(PacketEvent event) {
        ...
        } else if (event.getPacket() instanceof S2BPacketChangeGameState && !this.weather.getModeString().equals("Unchanged")) {
