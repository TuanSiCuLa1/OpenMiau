...
public enum Themes {
    ...
    LEGACY("Legacy", new Color(0x70CEFF), new Color(0x70CEFF), EnumChatFormatting.AQUA, KeyColors.AQUA, KeyColors.DARK_BLUE),
    WINTER("Winter", Color.WHITE, Color.WHITE, GRAY, KeyColors.GRAY, KeyColors.GRAY),
    PEONY("Peony", new Color(226, 208, 249), new Color(207, 171, 255), DARK_AQUA, KeyColors.PINK, KeyColors.GRAY),
    ...
    CREIDA("Creida", new Color(0xff4e5270).brighter().brighter(), new Color(0xff4e5270).darker(), RESET, KeyColors.GRAY),
    CREIDA_TWO("Creida Two", new Color(0xff9ACAEB), new Color(0xff7FBBE6).darker(), RESET, KeyColors.GRAY),
    ...
    private static Themes currentTheme = Themes.BLEND;
    ...
    Themes(String themeName, Function<Vector2d, Color> custom, EnumChatFormatting chatAccentColor, KeyColors... keyColors) {
        this.themeName = themeName;
        this.custom = custom;
        this.chatAccentColor = chatAccentColor;
        this.keyColors = new ArrayList<>(Arrays.asList(keyColors));
    ...
    public static void setBackgroundShade(Color color) {
